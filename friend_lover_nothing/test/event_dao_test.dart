...
void main() {
  ...
  group('http_request_fetch', () {
    test('returns Events from REST API', () async {
      final client = MockClient();

      // Use Mockito to return a successful response when it calls the
      // provided http.Client.
      when(client.get(Uri.parse(
              '$backendURL/$eventPath/51690ba7-ea0a-4e85-bb4c-f203da4208bf')))
          .thenAnswer((_) async => http.Response(
              ...
              200));
      List<Event> events =
          await fetchEvents(client, '51690ba7-ea0a-4e85-bb4c-f203da4208bf');
